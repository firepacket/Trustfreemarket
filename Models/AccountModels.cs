...
namespace AnarkRE.Models
{
    ...
    public class RegisterModel
    {
        [Required]
        [Display(Name = "User name")]
        [StringLength(15, ErrorMessage = "Username must be between 4-15 digits", MinimumLength = 4)]
        public string UserName { get; set; }

        [Required]
        [Display(Name = "Email")]
        [StringLength(128, ErrorMessage = "Email must be between 4-128 digits", MinimumLength = 4)]
